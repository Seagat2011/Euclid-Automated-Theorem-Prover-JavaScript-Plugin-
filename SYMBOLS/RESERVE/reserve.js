                ...
                if(j!=j_2){
                    s_j.map(function(s_k,k){
                        s_j_2.map(function(s_k_2,k_2){
                            s_k_2.map(function(s_k_2_object,i_2){
                                var o = m_buildTensorReduction(tmpParser,s_k_2_object,j,j_2,k_2,i_2)
                                if(o){
                                    //tmpParser[j][k_2].push(o)
                                    tmpParser[j_2][k].push(o)
                                }/*
                                var o = m_buildTensorReduction(tmpParser,s_k_2_object,j_2,j,k,i_2)
                                if(o){
                                    tmpParser[j_2][k].push(o)
                                }*/
                                return s_k_2_object
                            })
                            s_k.map(function(s_k_object,i){
                                var o = m_buildTensorReduction(tmpParser,s_k_object,j,j_2,k_2,i)
                                if(o){
                                    tmpParser[j][k_2].push(o)
                                }
                                var o = m_buildTensorReduction(tmpParser,s_k_object,j_2,j,k,i)
                                if(o){
                                    tmpParser[j_2][k].push(o)
                                }
                                return s_k_object
