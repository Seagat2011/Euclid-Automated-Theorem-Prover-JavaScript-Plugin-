...
function scan_token(_in_)
{
   ...
   // GREEK OPERATORS
      ...
      '44CDEB54C6F2AEBAD54611201C26D6F0':function(s){ console.log('scan_token: *** Error *** - Illegal token or character - '+s) }, // MD5('OnError') //
   } // choose {}

   var result = _in_.map(function(r,i){
      r.map(function(v,j){
...
function my_func()
{
   ...
   postMessage ( { origin:'lexer',value:tok,error:err } )
...
function translatorTool()
{
   ...
   srcTranslated.value = my_func({ data:obj }).value.Print()
}
*/